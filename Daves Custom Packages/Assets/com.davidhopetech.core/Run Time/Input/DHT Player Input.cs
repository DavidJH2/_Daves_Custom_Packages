...
//     version 1.8.0
//     from Packages/com.davehopetech.core.dependency/Run Time/Input/DHT Player Input.inputactions
//
...
public partial class @DHTPlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ~@DHTPlayerInput()
    {
        Debug.Assert(!m_InitialActionMap.enabled, "This will cause a leak and performance issues, DHTPlayerInput.InitialActionMap.Disable() has not been called.");
    }
