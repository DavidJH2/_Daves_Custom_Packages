...
namespace TMPro
{
    ...
    /// </summary>
    [AddComponentMenu("UI/TextMeshPro - DHT Custom Input Field", 11)]
    public class DHT_TMP_InputField : Selectable,
        ...
        IScrollHandler
    {
        ...
        /// </summary>
        [SerializeField] private TouchScreenKeyboardEvent m_OnTouchScreenKeyboardStatusChanged = new TouchScreenKeyboardEvent();
        ...
        private void AdjustRectTransformRelativeToViewport(Vector2 startPosition, float height, bool isCharVisible)
        {
            ...
            Vector2 caretPosition = new Vector2(startPosition.x + textComponentLocalPosition.x + textViewportLocalPosition.x + localPosition.x,
            ...
            if (m_isLastKeyBackspace)
            {
                ...
                float lastCharPosition = localPosition.x + textViewportLocalPosition.x + textComponentLocalPosition.x + m_TextComponent.textInfo.characterInfo[m_TextComponent.textInfo.characterCount - 1].origin +
